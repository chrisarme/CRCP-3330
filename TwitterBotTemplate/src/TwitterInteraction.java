...
public class TwitterInteraction {
	...
	TwitterInteraction() {
		...
		try {
			...
			cb.setDebugEnabled(true).setOAuthConsumerKey("RksuZyGhDnfawzfChFfDNCjrG") //API Key here
					.setOAuthConsumerSecret("lzgTrJckHe5ou0ZPexBWlYOFF4SKdfvpQPbIf4dzxh7E2A7oNL") //Secret key here
					.setOAuthAccessToken("1060582999857774593-aXFGogbBBLP5bzzqaMsbDEwKBihBsQ") //access token here
					.setOAuthAccessTokenSecret("3MCxFuhLXsCCblsizMul2ic3hfwborSyD4mRrSnDVa4ni"); //secret access token here
